...
// ── ⏳ Typing Indicator Helper (Auto-Typing Animation) ──
...
// ── ⏳ Controlled Message Delivery with Natural Human Delay ──
...
app.post('/webhook', async (req, res) => {
  ...
  for (const entry of body.entry) {
    ...
    // ── 🤖 Gemini AI Streaming Interrupt Fallback ──
    ...
    // ── 🗣️ Standard Live Gemini AI Agent Chat ──
    const aiReply = await getGeminiReply(senderId, userText);
