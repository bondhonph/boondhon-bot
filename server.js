...
function scheduleFollowUps(senderId) {
  ...
  const intervals = [
    { time: 60*60*1000, msg: "Hi ভাইয়া/আপু! 😊 আপনার ওয়েডিং কার্ডের অর্ডারটি কি কনফার্ম করব? 🛍️" },
    { time: 2*60*60*1000, msg: "কোনো ডিজাইন কি পছন্দ হয়েছে? 💖 কাস্টমাইজেশন লাগলে জানাবেন! ✨" },
    { time: 6*60*60*1000, msg: "শুভ দিন! 🌸 আজই অর্ডার কনফার্ম করলে দ্রুত ডেলিভারি পাবেন! 🥰" },
    { time: 24*60*60*1000, msg: "আসসালামু আলাইকুম! 💌 BOONDHON-এর সাথে যোগাযোগের জন্য ধন্যবাদ। 🙏❤️" }
  ];
...
async function getGeminiReply(senderId, userMessage) {
  ...
  const systemText = "তুমি BOONDHON Printing House-এর AI Sales Agent 'Brishti Apa'। অত্যন্ত মিষ্টি ও আন্তরিক। ইমোজি ব্যবহার করবে। প্রাইস: ৫০ পিস Affordable=২৭৫০, Premium=৩২৫০। ১০০ পিস Affordable=৪৫০০, Premium=৫৫০০। ২০০ পিস Affordable=৭০০০, Premium=৯০০০। ২০০+ পিসে FREE আকদনামা। দাম বেশি বললে quality বলো, কমাবে না। সর্বোচ্চ ৩ বার আপত্তিতে ৫ টাকা ডিসকাউন্ট দিতে পারো।";

  try {
    const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${GEMINI_API_KEY}`, {
      method: 'POST', headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ contents, systemInstruction: { parts: [{ text: systemText }] }, generationConfig: { maxOutputTokens: 200, temperature: 0.7 } })
    });
    ...
    if (trigger) {
      ...
      if (trigger === 'price') {
        await sendMainMenu(senderId,
          ...
          '🎁 ধামাকা অফার: ২০০ পিস বা বেশি নিলে FREE আকদনামা! 🥰\n\n' +
      ...
      if (trigger === 'delivery') {
        await sendMainMenu(senderId,
          '🚚 ডেলিভারি ও পলিসি: 🏭\n\n' +
          '📍 অফিস: মানিকগঞ্জ\n' +
          '🏭 কারখানা: ঢাকা ফকিরাপুল, লালবাগ, বাংলাবাজার\n\n' +
          '📦 কুরিয়ারে সারা বাংলাদেশে ক্যাশ অন ডেলিভারি\n' +
          'সরাসরি অফিস/কারখানা থেকেও নেওয়া যাবে 🥰\n\n' +
          '🛍️ আজই অর্ডার বুক করব? ✨'
        );
        scheduleFollowUps(senderId);
        continue;
      }
      ...
      if (trigger === 'bangla_form') {
        await sendMsg(senderId,
          ...
          '• গায়ে হলুদ- তারিখ: | রোজ: | সময়: | স্থান:\n' +
          '• শুভ বিবাহ- তারিখ: | রোজ: | বরযাত্রা: | স্থান:\n' +
          '• বৌ-ভাত- তারিখ: | রোজ: | সময়: | স্থান:\n\n' +
          '📞 ফোন নম্বর:\n' +
          '❓ ছেলের পক্ষ নাকি মেয়ের পক্ষ?\n' +
